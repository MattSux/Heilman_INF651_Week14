...
async function getComments(postID) {
    const response = await fetch('https://jsonplaceholder.typicode.com/todos/1/comments?postId='+postID)
    .then(response => response.json())
    .then(json => console.log(json))
  }
...
async function getUser(userID) {
    const response = await fetch('https://jsonplaceholder.typicode.com/todos/1/users?id='+userID)
    .then(response => response.json())
    .then(json => console.log(json))
  }
...
async function getTodosForUser(userID) {
    const response = await fetch('https://jsonplaceholder.typicode.com/todos/1/todos?userId='+userID)
    .then(response => response.json())
    .then(json => console.log(json))
  }